...
const SelectCategoryDropdown = ({
        ...
        {Object.keys(relationShips)
          ...
          .map((category) => (
            <div className="flex flex-col">
              ...
              >
                <Checkbox onCheckedChange={(flag) => handleChange(flag, category)} />
  ...
  const handleChange = (checked: Boolean, categoryId: string) => {
            ...
            .map((category) => (
              <div className="flex flex-col">
                ...
                >
                  <Checkbox
                    name={category}
                    onCheckedChange={(flag) => handleChange(flag, category)}
                  />
                  <p className="text-[15px]">{categoriesMap?.[category]}</p>
                </div>
                {relationShips?.[category]?.children && (
