...
const SelectCategoryDropdown = ({
  ...
  const RenderCheckBox = ({
    ...
    let atleastOneChildSelected: Boolean = false;
    let isAllChildrenSelected: Boolean = Object.keys(relationShips?.children || {})?.length
      ? true
      : false;
    ...
    return (
      <div className="bg-red-100 flex flex-col">
        ...
        <p className="text-xs">ONE {atleastOneChildSelected ? "Yes" : "No"}</p>
        <p className="text-xs">ALL {isAllChildrenSelected ? "Yes" : "No"}</p>
