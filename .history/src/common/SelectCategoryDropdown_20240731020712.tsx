  ...
  const RenderCheckBox = ({
    ...
    if (isCategorySelected) {
      if (allChildrenSelected()) {
        return <div className="text-green-600">Fully Selected</div>;
      } else if (anyChildSelected()) {
        return <div className="text-yellow-600">Partially Selected</div>;
      } else {
        return <div className="text-gray-600">Selected</div>;
      }
    } else {
      return <div className="text-gray-600">Unselected</div>;
    }
