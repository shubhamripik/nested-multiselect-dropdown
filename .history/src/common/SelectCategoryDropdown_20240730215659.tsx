...
const SelectCategoryDropdown = ({
  ...
  return (
    <div className="w-full flex flex-row justify-center items-center bg-red-100">
      <Select>
        <SelectTrigger className="w-[250px] bg-red-300">
          <SelectValue placeholder="Select categories" />
        </SelectTrigger>
        <SelectContent className="w-[500px] bg-red-600">
          <SelectGroup>
